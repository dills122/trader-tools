...
export default <T, B>(config: ServiceConfigItem, credentials: grpc.ChannelCredentials): B => {
  ...
  return new grpcObj[config.namespace][config.serviceName](server_address, credentials);
};

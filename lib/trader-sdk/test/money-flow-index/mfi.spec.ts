...
describe('Bollinger Bands::', function () {
  ...
  it('Happy path 20 period', () => {
    const data = buildCandlesFromArrays({
      highPrices: [25.03, 24.91, 24.89, 25.13, 25.0, 25.01, 25.1, ...FourteenDayPeriod.high],
      lowPrices: [25.03, 24.91, 24.89, 25.13, 25.0, 25.01, 25.1, ...FourteenDayPeriod.low],
      closePrices: [25.03, 24.91, 24.89, 25.13, 25.0, 25.01, 25.1, ...FourteenDayPeriod.close],
      volumeAmounts: [5673, 5625, 5023, 7457, 25.0, 25.01, 25.1, ...FourteenDayPeriod.volume]
    });
    const mfi = new MFIClass({
      candles: data,
      period: 20

import {
  DailyStockSentimentResults,
  StockSentimentResult
} from '../lib/sentiment-analysis/social-sentiment-io.service';
...
export const getDailyStockSentimentResults = (
  tickerSymbols: string[],
  length: number = tickerSymbols.length
) => {
